...
file = 'experiments/Experiment_open=0_turningcost=20_movingcost=20_discoveryreward=10_pumpreward=1000_safetyrange=40cm_maxiter=1_rnb=default_gr=default_tr=default_rps=default_h=20.csv'
