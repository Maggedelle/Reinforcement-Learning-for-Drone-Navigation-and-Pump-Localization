...
def init():
    ...
    if not os.path.exists(model_path):
        model_path = Model.get_model_path(model_name='AutoMLa99b1000b3')

    try:
        logger.info("Loading model from path: {}.".format(model_path))
        model_settings = {"img_size": 640, "model_size": "medium", "box_score_thresh": 0.2, "nms_iou_thresh": 0.5, "tile_grid_size": None, "tile_overlap_ratio": 0.25, "tile_predictions_nms_thresh": 0.25}
